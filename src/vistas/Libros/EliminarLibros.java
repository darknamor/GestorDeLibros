...
public class EliminarLibros extends javax.swing.JFrame {
    ...
    public EliminarLibros() {
        ...
        if (consul.getError() == null) {
            ...
            try {
                ...
                Logger.getLogger(EliminarLibros.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        int input = JOptionPane.showOptionDialog(null, "Esta seguro de que desea eliminar este Libro?, Aceptar para continuar", "Mensaje", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, null, null);
        if (input == JOptionPane.OK_OPTION) {
            ...
            String sql;
            //String val="1";
            sql = "UPDATE libros SET libros_estado=? WHERE libros_id=?";
